...
@Mod("morexpitems")
public class MorexpitemsMod {
	public static final Logger LOGGER = LogManager.getLogger(MorexpitemsMod.class);
	public static final String MODID = "morexpitems";

	public MorexpitemsMod(IEventBus modEventBus) {
